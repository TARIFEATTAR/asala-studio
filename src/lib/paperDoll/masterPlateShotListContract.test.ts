...
function fixture(): PaperDollMasterShotList {
  return {
    schemaVersion: 1,
    generatedFrom: { catalogBacklogPath: "a", catalogBacklogSha256: SHA, familyIntakesPath: "b", familyIntakesSha256: SHA, componentAuthorityQueuePath: "c", componentAuthorityQueueSha256: SHA },
    summary: { operationalRowCount: 1, sourceBackedPlateCount: 1, bodyAppearancePlateCount: 1, explicitComponentPlateCount: 0, exactSourceBackedExistingCount: 0, exactSourceBackedOutstandingCount: 1, supplementalExistingCount: 0, missingSourceResponsibilityCount: 0 },
