...
export const PaperDollMasterShotListSchema = z.object({
  ...
  summary: z.object({
    ...
    localReviewCandidateGeometryFamilyCount: z.number().int().nonnegative(),
    localReviewCandidateIdentityCount: z.number().int().nonnegative(),
    localReviewCandidateOutputCount: z.number().int().nonnegative(),
