...
export const CYLINDER_PAPER_DOLL_PRESENTATION_POSITIONS = [
  ...
  { displayKey: "roll-on|9|classic-20", label: "9 mL classic 20 mm roll-on", lane: "roll-on", capacityMl: 9, bodyHeightMm: 70, assembledHeightMm: 83, status: "blocked", familyCorrectionPct: 0, blocker: "No exact supplied or approved reference exists for the distinct 70 × 20 mm shell." },
