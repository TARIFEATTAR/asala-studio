...
- Three distinct dimension-calibrated cap candidate families now cover 13 catalog appearances: nine 13-415 roll-on overcaps, two 13-415 standard caps, and two 15-415 standard caps. The 13-415 profiles are 17 × 24 mm; the 15-415 profile is 19 × 32 mm. Every variant within its own family has byte-identical clamped alpha, but all three profiles remain review-only: geometry lock, production eligibility, family placement, Current Release, and Sanity state are all unchanged.
