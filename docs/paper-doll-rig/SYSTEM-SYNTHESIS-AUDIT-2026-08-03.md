...
- Three physical-review boundaries are recorded: split direct-bulb and tassel atomizers, quarantine the clear-protected lotion pump for responsibility decomposition, and keep 20-400 dropper pipette length body-contextual because 1 oz/2 oz source photography is duplicated.
- Five distinct dimension-calibrated cap candidate families now cover 18 catalog appearances: nine 13-415 roll-on overcaps, two 13-415 standard caps, two 15-415 standard caps, three 18-415 short caps, and two 18-415 tall caps. The short and tall 18-415 profiles remain separate because their verified heights differ. Every variant within its own family has byte-identical clamped alpha, but all five profiles remain review-only: geometry lock, production eligibility, family placement, Current Release, and Sanity state are all unchanged.
