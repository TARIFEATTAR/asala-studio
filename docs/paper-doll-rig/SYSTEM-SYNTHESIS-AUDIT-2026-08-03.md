...
- One dimension-calibrated 13-415 roll-on overcap candidate family now covers nine catalog appearances from a single 17 × 24 mm parametric Blender profile. All nine variants have byte-identical clamped alpha, but the profile remains review-only: geometry lock, production eligibility, family placement, Current Release, and Sanity state are all unchanged.
