...
- The 15-415 kit now also has two dimension-calibrated authority-candidate families. Five exposed-head appearances share one source-aspect mask at the verified 20 mm width, and five protective-overcap appearances share one 20 × 41 mm Blender mask. Every candidate is exact-alpha clamped and has been rendered across the five locked CYL-9ML bodies. The dip tube remains body-contextual. Real-file topology cleanup is source-specific and records one 77,022-pixel retained head plus nine 4–13 pixel detached artifacts; no global island threshold was introduced. Named geometry and family-fit approval, Current Release, and Sanity remain unchanged.
