...
- Six distinct dimension-calibrated cap candidate families now cover 21 catalog appearances, adding three smooth 8-425 tall caps to the prior 18. Every variant within its own family has byte-identical clamped alpha, but all six profiles remain review-only: geometry lock, production eligibility, family placement, Current Release, and Sanity state are all unchanged.
