...
| `roll-on|28` | 28 mL big roll-on | authority-build-ready | `body__cylinder__28ml__81x31x31.0__78183a1776` | Approve the exact-folder 81 × 31 mm body and source-calibrated plastic/metal large-roller authorities. Exclude sidecar cap placement; seat any closed-cap recipe only from verified closed reference or measured capped-height evidence. |
| `roll-on|50` | 50 mL big roll-on | authority-build-ready | `body__cylinder__50ml__98x37x37.0__d5cabe6ea2` | Approve the exact-folder 98 × 37 mm body and source-calibrated plastic/metal large-roller authorities. Exclude sidecar cap placement; calibrate closed-cap recipes separately from the 28 mL family using verified seating evidence. |
