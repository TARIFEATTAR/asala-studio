...
|---|---|---|---|---|
| `spray|3` | 3 mL spray | authority-build-ready | `body__cylinder__3ml__37x14x14.0__aa7c8c6e6d` | Build and name the 37 × 14 mm body authority; decompose the exact 12 mm sprayer source and fit its tube in body context. |
| `spray|4` | 4 mL spray | authority-build-ready | `body__cylinder__4ml__49x14x14.0__c3932dacb5` | Build and name the 49 × 14 mm body authority; reuse only the physically verified 12 mm sprayer cohort and calibrate the tube to this interior. |
...
| `spray|9|tall` | 9 mL tall 13-415 spray | authority-build-ready | `body__cylinder__9ml__106x18x18.0__fca612c530` | Extract the registered tall body profile, clamp material pixels to its authority, then map the 13-415 sprayer kit at the tall-family seat. |
...
| `roll-on|9|classic-20` | 9 mL classic 20 mm roll-on | candidate-ready-for-named-approval | `body__cylinder__9ml__70x20x20.0__7795014140` | Use the exact approved 70 × 20 mm five-body plate family and the approved shared 17-415 roller assets; complete named family-fit and release-cut approval. |
| `roll-on|9|classic-21` | 9 mL classic 21 mm roll-on | exact-reference-required | `body__cylinder__9ml__70x21x21.0__fc23539b78` | Locate and approve an exact classic 70 × 21 mm product reference; do not infer it from the 20 mm or 74 mm-height shell. |
| `roll-on|9|regular` | 9 mL regular roll-on | truth-decision-required | `body__cylinder__9ml__74x21x21.0__c3c136fd9e` | Keep the source-backed 74 × 21 mm body as reference-only evidence while the five locked 70 × 20 mm plates remain the active 9 mL 17-415 body authority; require an explicit catalog-identity decision before treating 74 × 21 mm as a separate production shell. |
| `roll-on|9|tall` | 9 mL tall roll-on | authority-build-ready | `body__cylinder__9ml__106x18x18.0__fca612c530` | Build the shared tall body authority, then create a separate tall-family placement for the 13-415 roller and cap profiles. |
| `roll-on|28` | 28 mL big roll-on | authority-build-ready | `body__cylinder__28ml__81x31x31.0__78183a1776` | Approve the 81 × 31 mm body, build a true large 16 mm plastic/metal roller authority from measured or exact catalog evidence, and keep the invalid small source roller quarantined; then calibrate the four assemblies specifically to the 28 mL body. |
| `roll-on|50` | 50 mL big roll-on | authority-build-ready | `body__cylinder__50ml__98x37x37.0__d5cabe6ea2` | Approve the 98 × 37 mm body, build a true large 16 mm plastic/metal roller authority from measured or exact catalog evidence, and keep the invalid small source roller quarantined; then calibrate placement separately from the 28 mL family. |
...
| `CYL-JUMBO-16MM-ROLLON` | authority-build-ready | 28 and 50 mL bodies; plastic and metal roller fitments; black and white caps; 8 exact assemblies | Clean component masks, remove neck pixels from metal references, and calibrate both capacities separately. |
