...
- Background: seamless Best Bottles Bone backdrop (#F5F3EF) with a subtle paper grain, completely uncluttered, no gradient, no texture pattern, no vignette
...
- [ ] Background is Best Bottles Bone `#F5F3EF` — sample 4 corner pixels
